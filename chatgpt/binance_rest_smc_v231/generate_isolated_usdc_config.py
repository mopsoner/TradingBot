...
from console_colors import headline, info, success
...
def main() -> None:
    ...
    isolated = client.isolated_margin_pairs()
    ...
    for row in info_payload.get("symbols", []):
        ...
        if not symbol or symbol not in isolated:
            continue
    ...
    print(headline(f"Generated isolated static config: {output_path}"))
