...
- Persistance SQLite des exécutions paper/live simulées.
- Backtesting avec split walk-forward train/validation/test.
- Exécution live Binance sécurisée par opt-in et clés API (OPENCLAW_LIVE_ENABLED + BINANCE_API_KEY/SECRET).
