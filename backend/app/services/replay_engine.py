...
def _run_replay(
    ...
    try:
        ...
        for idx, current_candle in enumerate(candles_15m_in_range):
            ...
            # Fenêtre 1H pour Step 0 (EQH/EQL) — lookback 24h (24 bougies)
            _LIQ_1H = 24
            window_4h_liq = candles_1h[max(0, idx_1h - _LIQ_1H): idx_1h]
