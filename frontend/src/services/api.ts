...
export const api = {
  ...
  realScan:       (body: { symbol: string; timeframe: string; days: number; profile_id?: number | null; step_bars?: number }) => post<Record<string, unknown>>('/api/data/real-scan', body),
  realScanStatus: () => get<Record<string, unknown>>('/api/data/real-scan/status'),
